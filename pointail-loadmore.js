...
(function () {
  'use strict';
  var MODS = ['pointail-theme.js?v=1', 'pointail-home.js?v=5', 'pointail-nav.js?v=3', 'pointail-rules-sync.js?v=1', 'pointail-autosync.js?v=2', 'pointail-rep-unify.js?v=2', 'pointail-advmgr-rep.js?v=4', 'pointail-monthly.js?v=6', 'pointail-cost.js?v=6'];
  function load(src) {
